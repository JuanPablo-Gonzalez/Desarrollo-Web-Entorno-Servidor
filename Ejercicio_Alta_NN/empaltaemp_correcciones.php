...
<body>
    <form name="formulario" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <label for="fechaAlta">Fecha de Alta Empleado</label> <!--Poner la fecha del sistema, no nosotros.-->
        <input type="text" name="fechaAlta"> <br>
        <label for="departamentos">Nombre Departamento del empleado</label> 
        <?php
            echo "<select name='departamentos'>"; //fuera
                /* Poner cod_dpto en el value, para no tener que hacer la select para conseguirlo luego.
    ...
    <?php
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $fechaAlta= limpiar($_POST["fechaAlta"]);
            ...
            mysqli_close($mysqli); //crear un método para cerrar conexión.
        ...
        /*Hacer los próximos con PDO (no con mysqli_query) 
        y cambiar los de la select de arriba, haciendo los <select> fuera y poniendo
        el cod empledo en value.*/
	?>
</body>
</html>