...
/*
Al principio hice este código, funcionaba bien pero me di cuenta de que no controlaba
que un mismo jugador tuviese dos cartones ganadores, por eso lo hice de la otra forma,
que sí lo controla.
*/
...
while(!$ganador1&&!$ganador2&&!$ganador3&&!$ganador4) {
	...
	AL ARRAY DE TACHADOS, SIGNIFICARÁ QUE ESE JUGADOR HA GANADO CON ESE CARTÓN.*/
	$cartonTachado= array("--","--","--","--","--","--","--","--","--","--","--","--","--","--","--");
	$cartonGanadorJ1;
	$cartonGanadorJ2;
	$cartonGanadorJ3;
